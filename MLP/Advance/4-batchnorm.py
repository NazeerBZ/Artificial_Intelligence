...
def mlp_model():
    ...
    hidden2 = Dense(units=50, activation='sigmoid')(batchNorm1)
    batchNorm2 = BatchNormalization()(hidden2)
    hidden3 = Dense(units=50, activation='sigmoid')(batchNorm2)
    batchNorm3 = BatchNormalization()(hidden3)
    output = Dense(units=10, activation='softmax')(batchNorm3)
