...
def mlp_model():
    ...
    hidden1 = Dense(units=50, kernel_initializer='he_normal', activation='relu')(visible)
    batchNorm1 = BatchNormalization()(hidden1)
    dropout1 = Dropout(0.2)(batchNorm1)
    hidden2 = Dense(units=50, kernel_initializer='he_normal', activation='relu')(dropout1)
    batchNorm2 = BatchNormalization()(hidden2)
    dropout2 = Dropout(0.2)(batchNorm2)
    hidden3 = Dense(units=50, kernel_initializer='he_normal', activation='relu')(dropout2)
    batchNorm3 = BatchNormalization()(hidden3)
    dropout3 =  Dropout(0.2)(batchNorm3)
    output = Dense(units=10, kernel_initializer='he_normal', activation='softmax')(dropout3)
